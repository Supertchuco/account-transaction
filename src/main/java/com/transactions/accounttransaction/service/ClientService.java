...
public class ClientService {
    ...
    public Client findClientByClientId(final int clientId){
        log.info("find client with client id: {}", clientId);
        return clientRepository.findClientId(clientId);
    }

    public Client findClientByAccountId(final int accountId){
        log.info("find client by account id: {}", accountId);
        return clientRepository.findClientId(accountId);
    }
